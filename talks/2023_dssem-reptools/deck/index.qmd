...
[https://forms.gle/5izjdTKtprfo5vFy5](https://forms.gle/5izjdTKtprfo5vFy5)  

If you're attending **online**, link shared on chat.  
If you're attending in person, scan below:  

::: {.fragment }  
![](qrcode-survey.png){.absolute top=91% left=50% width=200 height=200}  
:::
...
::: columns  
::: {.column width="50%"}
- This entire presentation was made with **quarto**, and its source code is available on [my GitHub](https://github.com/leombastos/bastoslab/blob/main/talks/2022_uiuc-reptools/deck/index.qmd)  
...
::: {.column width="50%"}
- You can also find stats programing teaching material (video+code) on my [website](https://leombastos.github.io/bastoslab/teaching/teaching.html)  
